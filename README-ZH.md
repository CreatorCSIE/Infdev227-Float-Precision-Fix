...
**一个修复Infdev 2010-2-27浮点数精度问题的Mod。**

## 这个mod是做什么的？
**我使用了AI帮助我修复了Infdev 2010-2-27的一些距离现象。**
...
随后将文件复制到Infdev (2010-2-27) 的jar 中并进行替换。
...
* [RetroMCP](https://github.com/Blizzardfur-Maxxx/RetroMCP-Java-Unofficial) （解包Minecraft并重新打包）
* CreatorCSIE （上传者）
